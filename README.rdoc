...
- Adds Flash messages display and checking in layout
- Removes fixtures
...
- Adds Devise auth and signup as well as User model with
- Adds i18n (internationalization) to views (devise-i18n-views gem used for
the Devise views)
- Adds version dependencies to all gems in gemfile
- Adds Factory Girl rails gem for fixtures
- Adds User fixture with sequenced emails
- Updates generator defaults to use factories and remove unneeded things
